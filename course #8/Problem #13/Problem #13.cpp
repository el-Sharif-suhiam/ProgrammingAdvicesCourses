...
{
    sDate date1, date2;
    date1.year = ReadNum("Enter the Year : ");
    date1.month = ReadNum("Enter the month : ");
    date1.day = ReadNum("Enter the day : ");
    cout << "Now Enter date 2 : \n\n";
    date2.year = ReadNum("Enter the Year : ");
    date2.month = ReadNum("Enter the month : ");
    date2.day = ReadNum("Enter the day : ");
    ...
    //short addedDays = ReadNum("Enter the days you want to add : ");

    //short totalD = DaysFromStart(year, month, day);
    //sDate date = DaysToDate(totalD, year);
    //printf("\nNumber of days from the begining of the year is %d \n", totalD);
    //printf("the date is: %s \n", DaysToDate(totalD, year).c_str());
    //AddedDaysToDate(addedDays, date);
    /*cout << "the date is:" << date.day << "/"
